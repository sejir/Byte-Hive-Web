...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            'App\\Controller\\GuideAdminController' => 'getGuideAdminControllerService',
            'App\\Controller\\GuideController' => 'getGuideControllerService',
            'App\\Controller\\UpcomingeventsAdminController' => 'getUpcomingeventsAdminControllerService',
            'App\\Controller\\UpcomingeventsController' => 'getUpcomingeventsControllerService',
    ...
    /**
     * Gets the public 'App\Controller\GuideAdminController' shared autowired service.
     *
     * @return \App\Controller\GuideAdminController
     */
    protected function getGuideAdminControllerService()
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'GuideAdminController.php';

        $this->services['App\\Controller\\GuideAdminController'] = $instance = new \App\Controller\GuideAdminController();

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\GuideAdminController', $this));
    ...
    /**
     * Gets the public 'App\Controller\UpcomingeventsAdminController' shared autowired service.
     *
     * @return \App\Controller\UpcomingeventsAdminController
     */
    protected function getUpcomingeventsAdminControllerService()
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'framework-bundle'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'ControllerTrait.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'framework-bundle'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'AbstractController.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'UpcomingeventsAdminController.php';

        $this->services['App\\Controller\\UpcomingeventsAdminController'] = $instance = new \App\Controller\UpcomingeventsAdminController();

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\UpcomingeventsAdminController', $this));

        return $instance;
    }

    /**
     * Gets the public 'App\Controller\UpcomingeventsController' shared autowired service.
     *
     * @return \App\Controller\UpcomingeventsController
     */
    protected function getUpcomingeventsControllerService()
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'framework-bundle'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'ControllerTrait.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'framework-bundle'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'AbstractController.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'UpcomingeventsController.php';

        $this->services['App\\Controller\\UpcomingeventsController'] = $instance = new \App\Controller\UpcomingeventsController();

        $instance->setContainer(($this->privates['.service_locator.vdmMuyE'] ?? $this->get_ServiceLocator_VdmMuyEService())->withContext('App\\Controller\\UpcomingeventsController', $this));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('7fVziZhYve', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ar-WDim8LW', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\UpcomingeventsRepository' => ['privates', 'App\\Repository\\UpcomingeventsRepository', 'getUpcomingeventsRepositoryService', false],
        ], [
            'App\\Repository\\GuideRepository' => '?',
            'App\\Repository\\UpcomingeventsRepository' => '?',
        ])));
    ...
    /**
     * Gets the private '.errored..service_locator.EUCUzki.App\Entity\Guide' shared service.
     *
     * @return \App\Entity\Guide
     */
    protected function getGuideService()
    {
        $this->throw('Cannot autowire service ".service_locator.EUCUzki": it references class "App\\Entity\\Guide" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.G609UQS.App\Entity\Upcomingevents' shared service.
     *
     * @return \App\Entity\Upcomingevents
     */
    protected function getUpcomingeventsService()
    {
        $this->throw('Cannot autowire service ".service_locator.G609UQS": it references class "App\\Entity\\Upcomingevents" but no such service exists.');
    }

    /**
     * Gets the private '.errored..service_locator.l2SibCa.App\Entity\Upcomingevents' shared service.
     *
     * @return \App\Entity\Upcomingevents
     */
    protected function getUpcomingevents2Service()
    {
        $this->throw('Cannot autowire service ".service_locator.l2SibCa": it references class "App\\Entity\\Upcomingevents" but no such service exists.');
    }
     ...
     * @return \App\Entity\Guide
     */
    protected function getGuide2Service()
    {
    ...
    /**
     * Gets the private '.service_locator.0HphQEc' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_0HphQEcService()
    {
        return $this->privates['.service_locator.0HphQEc'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'upcomingeventsRepository' => ['privates', 'App\\Repository\\UpcomingeventsRepository', 'getUpcomingeventsRepositoryService', false],
        ], [
            'upcomingeventsRepository' => 'App\\Repository\\UpcomingeventsRepository',
        ]);
    }

    /**
     * Gets the private '.service_locator.EUCUzki' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_EUCUzkiService()
    {
        return $this->privates['.service_locator.EUCUzki'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'guide' => ['privates', '.errored..service_locator.EUCUzki.App\\Entity\\Guide', NULL, 'Cannot autowire service ".service_locator.EUCUzki": it references class "App\\Entity\\Guide" but no such service exists.'],
    ...
    /**
     * Gets the private '.service_locator.G609UQS' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_G609UQSService()
    {
        return $this->privates['.service_locator.G609UQS'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'upcomingevent' => ['privates', '.errored..service_locator.G609UQS.App\\Entity\\Upcomingevents', NULL, 'Cannot autowire service ".service_locator.G609UQS": it references class "App\\Entity\\Upcomingevents" but no such service exists.'],
            'upcomingeventsRepository' => ['privates', 'App\\Repository\\UpcomingeventsRepository', 'getUpcomingeventsRepositoryService', false],
        ], [
            'upcomingevent' => 'App\\Entity\\Upcomingevents',
            'upcomingeventsRepository' => 'App\\Repository\\UpcomingeventsRepository',
        ]);
    }

    /**
     * Gets the private '.service_locator.NvIpxTX' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_NvIpxTXService()
    {
        return $this->privates['.service_locator.NvIpxTX'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\GuideController::delete' => ['privates', '.service_locator.EUCUzki', 'get_ServiceLocator_EUCUzkiService', false],
            'App\\Controller\\GuideController::edit' => ['privates', '.service_locator.EUCUzki', 'get_ServiceLocator_EUCUzkiService', false],
            'App\\Controller\\GuideController::index' => ['privates', '.service_locator.z8INnim', 'get_ServiceLocator_Z8INnimService', false],
            'App\\Controller\\GuideController::new' => ['privates', '.service_locator.z8INnim', 'get_ServiceLocator_Z8INnimService', false],
            'App\\Controller\\GuideController::show' => ['privates', '.service_locator.q1y3I1n', 'get_ServiceLocator_Q1y3I1nService', false],
            'App\\Controller\\UpcomingeventsAdminController::index' => ['privates', '.service_locator.kHmzdEi', 'get_ServiceLocator_KHmzdEiService', false],
            'App\\Controller\\UpcomingeventsController::delete' => ['privates', '.service_locator.G609UQS', 'get_ServiceLocator_G609UQSService', false],
            'App\\Controller\\UpcomingeventsController::edit' => ['privates', '.service_locator.0HphQEc', 'get_ServiceLocator_0HphQEcService', false],
            'App\\Controller\\UpcomingeventsController::index' => ['privates', '.service_locator.kHmzdEi', 'get_ServiceLocator_KHmzdEiService', false],
            'App\\Controller\\UpcomingeventsController::new' => ['privates', '.service_locator.kHmzdEi', 'get_ServiceLocator_KHmzdEiService', false],
            'App\\Controller\\UpcomingeventsController::show' => ['privates', '.service_locator.l2SibCa', 'get_ServiceLocator_L2SibCaService', false],
            'App\\Controller\\GuideController:delete' => ['privates', '.service_locator.EUCUzki', 'get_ServiceLocator_EUCUzkiService', false],
            'App\\Controller\\GuideController:edit' => ['privates', '.service_locator.EUCUzki', 'get_ServiceLocator_EUCUzkiService', false],
            'App\\Controller\\GuideController:index' => ['privates', '.service_locator.z8INnim', 'get_ServiceLocator_Z8INnimService', false],
            'App\\Controller\\GuideController:new' => ['privates', '.service_locator.z8INnim', 'get_ServiceLocator_Z8INnimService', false],
            ...
            'App\\Controller\\UpcomingeventsAdminController::index' => '?',
            'App\\Controller\\UpcomingeventsController::delete' => '?',
            'App\\Controller\\UpcomingeventsController::edit' => '?',
            'App\\Controller\\UpcomingeventsController::index' => '?',
            'App\\Controller\\UpcomingeventsController::new' => '?',
            'App\\Controller\\UpcomingeventsController::show' => '?',
            'App\\Controller\\GuideController:delete' => '?',
            'App\\Controller\\GuideController:edit' => '?',
            'App\\Controller\\GuideController:index' => '?',
            'App\\Controller\\GuideController:new' => '?',
    ...
    /**
     * Gets the private '.service_locator.kHmzdEi' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_KHmzdEiService()
    {
        return $this->privates['.service_locator.kHmzdEi'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'upcomingeventsRepository' => ['privates', 'App\\Repository\\UpcomingeventsRepository', 'getUpcomingeventsRepositoryService', false],
        ], [
            'upcomingeventsRepository' => 'App\\Repository\\UpcomingeventsRepository',
        ]);
    ...
    /**
     * Gets the private '.service_locator.l2SibCa' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_L2SibCaService()
    {
        return $this->privates['.service_locator.l2SibCa'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'upcomingevent' => ['privates', '.errored..service_locator.l2SibCa.App\\Entity\\Upcomingevents', NULL, 'Cannot autowire service ".service_locator.l2SibCa": it references class "App\\Entity\\Upcomingevents" but no such service exists.'],
        ], [
            'upcomingevent' => 'App\\Entity\\Upcomingevents',
        ]);
    }
    ...
    /**
     * Gets the private 'App\Form\UpcomingeventsType' shared autowired service.
     *
     * @return \App\Form\UpcomingeventsType
     */
    protected function getUpcomingeventsTypeService()
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'form'.\DIRECTORY_SEPARATOR.'FormTypeInterface.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'form'.\DIRECTORY_SEPARATOR.'AbstractType.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Form'.\DIRECTORY_SEPARATOR.'UpcomingeventsType.php';

        return $this->privates['App\\Form\\UpcomingeventsType'] = new \App\Form\UpcomingeventsType();
    }
    ...
    /**
     * Gets the private 'App\Repository\UpcomingeventsRepository' shared autowired service.
     *
     * @return \App\Repository\UpcomingeventsRepository
     */
    protected function getUpcomingeventsRepositoryService()
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'persistence'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Persistence'.\DIRECTORY_SEPARATOR.'ObjectRepository.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'collections'.\DIRECTORY_SEPARATOR.'lib'.\DIRECTORY_SEPARATOR.'Doctrine'.\DIRECTORY_SEPARATOR.'Common'.\DIRECTORY_SEPARATOR.'Collections'.\DIRECTORY_SEPARATOR.'Selectable.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'orm'.\DIRECTORY_SEPARATOR.'lib'.\DIRECTORY_SEPARATOR.'Doctrine'.\DIRECTORY_SEPARATOR.'ORM'.\DIRECTORY_SEPARATOR.'EntityRepository.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'doctrine-bundle'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'doctrine-bundle'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UpcomingeventsRepository.php';

        return $this->privates['App\\Repository\\UpcomingeventsRepository'] = new \App\Repository\UpcomingeventsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4rj0N0bX-l', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oGz+niyPzY', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0fphSJNNbN', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yZfY8++PJ5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.NvIpxTX'] ?? $this->get_ServiceLocator_NvIpxTXService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
    ...
    protected function getForm_RegistryService()
    {
        ...
        return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Form\\UpcomingeventsType' => ['privates', 'App\\Form\\UpcomingeventsType', 'getUpcomingeventsTypeService', false],
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder26f69 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerd36ed = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties87fdb = [
        
    ];

    public function getConnection()
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'getConnection', array(), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'getMetadataFactory', array(), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'getExpressionBuilder', array(), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'beginTransaction', array(), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'getCache', array(), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->getCache();
    }

    public function transactional($func)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'transactional', array('func' => $func), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'wrapInTransaction', array('func' => $func), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'commit', array(), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->commit();
    }

    public function rollback()
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'rollback', array(), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'getClassMetadata', array('className' => $className), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'createQuery', array('dql' => $dql), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'createNamedQuery', array('name' => $name), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'createQueryBuilder', array(), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'flush', array('entity' => $entity), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'clear', array('entityName' => $entityName), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->clear($entityName);
    }

    public function close()
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'close', array(), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->close();
    }

    public function persist($entity)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'persist', array('entity' => $entity), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'remove', array('entity' => $entity), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'refresh', array('entity' => $entity), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'detach', array('entity' => $entity), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'merge', array('entity' => $entity), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'getRepository', array('entityName' => $entityName), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'contains', array('entity' => $entity), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'getEventManager', array(), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'getConfiguration', array(), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'isOpen', array(), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'getUnitOfWork', array(), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'getProxyFactory', array(), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'initializeObject', array('obj' => $obj), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'getFilters', array(), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'isFiltersStateClean', array(), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'hasFilters', array(), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return $this->valueHolder26f69->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerd36ed = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder26f69) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder26f69 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder26f69->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, '__get', ['name' => $name], $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        if (isset(self::$publicProperties87fdb[$name])) {
            return $this->valueHolder26f69->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder26f69;
    ...
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;
    ...
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, '__isset', array('name' => $name), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;
    ...
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, '__unset', array('name' => $name), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;
    ...
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, '__clone', array(), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        $this->valueHolder26f69 = clone $this->valueHolder26f69;
    }

    public function __sleep()
    {
        $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, '__sleep', array(), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;

        return array('valueHolder26f69');
    }
    ...
    {
        $this->initializerd36ed = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerd36ed;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerd36ed && ($this->initializerd36ed->__invoke($valueHolder26f69, $this, 'initializeProxy', array(), $this->initializerd36ed) || 1) && $this->valueHolder26f69 = $valueHolder26f69;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder26f69;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder26f69;
    }
}
